...
public class KafkaStatusConsumer {
    ...
    public void listenStatusPrimary(ConsumerRecord<String, PayloadCompletionStatus> record) {
    ...
    public void listenStatusSecondary(ConsumerRecord<String, PayloadCompletionStatus> record) {
    ...
    public void listenStatusTertiary(ConsumerRecord<String, PayloadCompletionStatus> record) {
        process(record, "cluster-3");
    }

    private void process(ConsumerRecord<String, PayloadCompletionStatus> record, String clusterId) {
